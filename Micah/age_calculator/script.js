...
var calculateAge =  function(birthYear, countYear) {
  if (birthYear < countYear) {
    return "You are " + (countYear - birthYear) + " year(s) old.";
  }
  if (birthYear > countYear) {
    return "You will be born in " + (birthYear - countYear) + " year(s).";
  }
  if (birthYear === countYear) {
...
console.log(calculateAge(1982, 2000));
console.log(calculateAge(2012, 2000));
console.log(calculateAge(1994, 1994));
